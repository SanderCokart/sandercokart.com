...
<body
    ...
    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="margin-left:auto;margin-right:auto;margin-top:3rem;margin-bottom:3rem;max-width:600px;border-radius:0.5rem;background-color:rgb(255,255,255);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), 0 1px 2px 0 rgb(0,0,0,0.05)">
        <tbody>
            <tr style="width:100%">
                <td>
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                        role="presentation"
                        style="background-color:rgb(76,29,149);border-top-left-radius:0.5rem;border-top-right-radius:0.5rem;padding:1rem;text-align:center">
                        <tbody>
                            <tr>
                                <td>
                                    <h1
                                        style="font-size:1.5rem;line-height:2rem;font-weight:700;color:rgb(255,255,255)">
                                        New Project Inquiry
                                    </h1>
                                </td>
                            </tr>
                    ...
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                        role="presentation" style="margin-top:1rem;padding-left:1rem;padding-right:1rem">
                        <tbody>
                            <tr>
                                <td>
                                    <pre
...
{{ $data['message'] }}</pre>
                    ...
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                        role="presentation" style="margin-top:1rem;margin-bottom:1rem;text-align:center">
                        <tbody>
                            <tr>
                                <td>
                    ...
                    <hr
                        style="border-color:rgb(76,29,149)!important;margin-top:0px;margin-bottom:0px;width:100%;border:none;border-top:1px solid #eaeaea" />
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                        role="presentation"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <p style="margin:0px;font-size:0.875rem;line-height:1.25rem;color:rgb(107,114,128)">
                                        ©
                                        <!-- -->2026<!-- -->
