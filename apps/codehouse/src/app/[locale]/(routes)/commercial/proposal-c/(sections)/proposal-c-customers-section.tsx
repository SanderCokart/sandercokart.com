...
export const ProposalCCustomersSection: FC<ComponentProps<'section'>> = ({ className, ...props }) => {
  const t = useTranslations('CommercialProposalCCustomersSection');
            ...
            <div className="flex min-h-[16rem]">
              ...
              <div className="flex-1">
                <div className="border-border/40 text-muted-foreground grid grid-cols-3 gap-2 border-b px-3 py-2 text-[10px] tracking-wider uppercase">
                  ...
                  <span>{t('mock_col_segment')}</span>
                  <span>{t('mock_col_status')}</span>
                </div>
                <MockTableRow cells={[t('mock_row_1_name'), t('mock_row_1_seg'), t('mock_row_1_status')]} highlight />
                <MockTableRow cells={[t('mock_row_2_name'), t('mock_row_2_seg'), t('mock_row_2_status')]} />
                <MockTableRow cells={[t('mock_row_3_name'), t('mock_row_3_seg'), t('mock_row_3_status')]} />
                <MockTableRow cells={[t('mock_row_4_name'), t('mock_row_4_seg'), t('mock_row_4_status')]} />
                <MockTableRow cells={[t('mock_row_5_name'), t('mock_row_5_seg'), t('mock_row_5_status')]} />
              </div>
            </div>
          </MockWindow>
        </MotionDiv>
