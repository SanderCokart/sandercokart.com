...
export function CommercialProposalAHero() {
  const t = useTranslations('CommercialProposalAHero');
  ...
  return (
    <section
      ...
      <div
        aria-hidden
        className="from-primary/15 via-background to-accent/10 dark:from-accent/20 dark:via-background dark:to-primary/15 pointer-events-none absolute inset-0 -z-10 bg-gradient-to-b"
      />
        ...
        <MotionDiv
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row">
            <Button
              ...
              className="min-w-48"
              nativeButton={false}
              render={<Link href={{ pathname: '/commercial/proposal-a', hash: 'quote' }} />}>
              {t('cta_primary')}
            ...
            <Button
              ...
              className="min-w-48"
              nativeButton={false}
              render={<Link href={{ pathname: '/commercial/proposal-a', hash: 'systems' }} />}>
              {t('cta_secondary')}
