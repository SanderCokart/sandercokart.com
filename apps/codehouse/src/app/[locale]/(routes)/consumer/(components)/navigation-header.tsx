    ...
    <nav className={cn('relative z-50 mx-auto w-full max-w-4xl')}> 
      <div className={cn('flex items-center justify-center gap-6 md:gap-8 py-2')}> 
        {/* <Link
          ...
          <span className={cn('hidden md:inline text-base')}>{t('navigation_portfolio')}</span>
        </Link>
        ...
        <Link
          ...
          <span className={cn('hidden md:inline text-base')}>{t('navigation_tech-stack')}</span>
        </Link>
        ...
        <Link
          ...
          <span className={cn('hidden md:inline text-base')}>{t('navigation_testimonials')}</span>
        </Link> */}
      </div>
    </nav>
  );
