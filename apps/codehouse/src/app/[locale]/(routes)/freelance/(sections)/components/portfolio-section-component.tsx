...
interface PortfolioSectionComponentProps {
  t: ReturnType<typeof useTranslations>;
}

export const PortfolioSectionComponent: FC<PortfolioSectionComponentProps> = ({ t }) => {
  return (
    <section className={cn('flex scroll-mt-16 flex-col sm:scroll-mt-16')} id="portfolio">
