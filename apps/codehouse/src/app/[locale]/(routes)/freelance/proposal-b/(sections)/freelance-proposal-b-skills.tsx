...
const skills = [
  { key: 'react', icon: LayoutTemplateIcon },
  { key: 'vue', icon: TriangleIcon },
  { key: 'next', icon: LayersIcon },
  { key: 'fullstack', icon: ServerIcon },
  { key: 'typescript', icon: BracesIcon },
  { key: 'agile', icon: GitBranchIcon },
] as const;

export const FreelanceProposalBSkills: FC<ComponentProps<'section'>> = ({ className, ...props }) => {
  const t = useTranslations('FreelanceProposalBSkills');
