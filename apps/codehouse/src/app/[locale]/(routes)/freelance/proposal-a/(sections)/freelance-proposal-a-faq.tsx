...
const faqs = [
  ...
  { question: 'faq_rates_question', answer: 'faq_rates_answer' },
  { question: 'faq_ip_question', answer: 'faq_ip_answer' },
  { question: 'faq_stack_question', answer: 'faq_stack_answer' },
  { question: 'faq_collaboration_question', answer: 'faq_collaboration_answer' },
  { question: 'faq_timeline_question', answer: 'faq_timeline_answer' },
  { question: 'faq_handoff_question', answer: 'faq_handoff_answer' },
] as const;

export const FreelanceProposalAFaq: FC<ComponentProps<'section'>> = ({ className, ...props }) => {
  const t = useTranslations('FreelanceProposalAFaq');
