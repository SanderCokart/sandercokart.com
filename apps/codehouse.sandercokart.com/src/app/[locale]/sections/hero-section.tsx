  ...
  return (
    <section
      ...
      <article className="flex-none space-y-4 md:w-7/12">
        ...
        <p className="cursor-pointer text-center text-xl font-bold transition-colors hover:text-accent/80 dark:text-accent dark:hover:text-accent/80 sm:text-left md:text-3xl">
