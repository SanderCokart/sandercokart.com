    ...
    return (
      <RemoveScroll>
          <div className="w-[90vw] xl:w-[75vw]">
              {!loaded && (
                <div
                  className="absolute w-full h-full animate-pulse grid place-items-center bg-primaryLight dark:bg-primaryDark">
...
const Lightbox = ({children}: LightboxProps) => {
    ...
    return (
      <Modal consumer={children} id="lightbox" isOpen={open} setOpen={setOpen}>
          <FaTimes
            className="absolute bottom-full left-full z-10 cursor-pointer rounded-full p-1 text-4xl bg-secondaryLight text-primaryLight dark:text-secondaryLight dark:bg-primary"
